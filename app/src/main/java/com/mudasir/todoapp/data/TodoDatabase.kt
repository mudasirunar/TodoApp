package com.mudasir.todoapp.data
    ...
    companion object {
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                val type = object : com.google.gson.reflect.TypeToken<List<com.mudasir.todoapp.data.TodoTask>>() {}.type
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (!tasksJson.isNullOrEmpty()) {
                            val tasks: List<com.mudasir.todoapp.data.TodoTask> = gson.fromJson(tasksJson, type)
